...
print("=" * 50)
print("TREINAMENTO COM TD3 (Twin Delayed DDPG)")
print("=" * 50)
...
print("\n4. Salvando o modelo...")
model.save("pendulum_td3_model")
print("Modelo salvo como 'pendulum_td3_model'")
