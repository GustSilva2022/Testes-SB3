...
print("=" * 50)
print("TREINAMENTO COM A2C (Advantage Actor-Critic)")
print("=" * 50)
...
print("\n4. Salvando o modelo...")
model.save("cartpole_a2c_model")
print("Modelo salvo como 'cartpole_a2c_model'")
